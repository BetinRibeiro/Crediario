...
public class JFrmInsReceitaExtra extends JDialog {
	...
	private ReceitaExtra despExtra = null;
	...
	public static void main(String[] args) {
		try {
			JFrmInsReceitaExtra dialog = new JFrmInsReceitaExtra(null);
	 ...
	 * Create the dialog.
	 */
	public JFrmInsReceitaExtra(Equipe equipe) {
		this.equpe = equipe;
		setTitle("Lan\u00E7amento de Receita Extra");
	...
	private void salvar() {
		try {
			...
			ReceitaExtra de = new ReceitaExtra(descricao, valor, data.getDate(), equpe);
	...
	public boolean inserir(ReceitaExtra desp) {
		try {
			this.despExtra = desp;
