...
public class ModelTabelaVendedorEquipeCobranca extends AbstractTableModel {

	private List<VendedorEquipe> dados;
	private String[] colunas = { "Código", "Nome", "Venda", "Recebido", "Devolvido", "Perdido", "Percentual","Saldo"};
	...
	public ModelTabelaVendedorEquipeCobranca() {
