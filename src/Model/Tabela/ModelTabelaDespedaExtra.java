...
public class ModelTabelaDespedaExtra extends AbstractTableModel {

	private List<DespExtra> dados;
	private String[] colunas = { "CÓDIGO", "DESCRIÇÃO", "DARA", "VALOR"};
	...
	public ModelTabelaDespedaExtra() {
		dados = new ArrayList<DespExtra>();

	}

	public void addRow(DespExtra p) {
