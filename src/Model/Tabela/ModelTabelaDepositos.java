...
public class ModelTabelaDepositos extends AbstractTableModel {

	private List<Deposito> dados;
	private String[] colunas = { "Código", "Banco", "Data", "Valor"};
	...
	public ModelTabelaDepositos() {
		dados = new ArrayList<Deposito>();

	}

	public void addRow(Deposito p) {
	...
	public Object getValueAt(int linha, int coluna) {
		...
		case 1:
			return (dados.get(linha).getBanco());
		case 2:
