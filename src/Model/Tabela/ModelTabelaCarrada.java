...
public class ModelTabelaCarrada extends AbstractTableModel {
	...
	public ModelTabelaCarrada() {
		dados = new ArrayList<Carrada>();

	}

	public void addRow(Carrada p) {
	...
	public Object getValueAt(int linha, int coluna) {
		...
		case 3:
			return (dados.get(linha).getMotorista());
		case 4:
			return df.format(dados.get(linha).getValorTotal());
