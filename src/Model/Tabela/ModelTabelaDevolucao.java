...
public class ModelTabelaDevolucao extends AbstractTableModel {

	private List<Devolucao> dados;
	...
	public ModelTabelaDevolucao() {
		dados = new ArrayList<Devolucao>();

	}

	public void addRow(Devolucao p) {
