...
public class ModelTabelaEquipeTransporteVenda extends AbstractTableModel {

	private List<TransporteViagem> dados;
	private String[] colunas = { "CÓDIGO", "TRANSPORTE", "KM RODADO", "MANUTENÇÃO"};
	...
	public ModelTabelaEquipeTransporteVenda() {
		dados = new ArrayList<TransporteViagem>();

	}

	public void addRow(TransporteViagem p) {
	...
	public Object getValueAt(int linha, int coluna) {
		...
		case 1:
			return dados.get(linha).getTransporte().getModelo()+" "+dados.get(linha).getTransporte().getPlaca()+" "+dados.get(linha).getTransporte().getCor();
		case 2:
			return (dados.get(linha).getKmfinal()-dados.get(linha).getKminicial());

		case 3:
			return df.format(dados.get(linha).getManutencao() );

		}
		return null;
	}

	public TransporteViagem getObj(int selectedRow) {
