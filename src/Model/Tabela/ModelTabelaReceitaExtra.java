...
public class ModelTabelaReceitaExtra extends AbstractTableModel {

	private List<ReceitaExtra> dados;
	private String[] colunas = { "CÓDIGO", "DESCRIÇÃO", "DATA", "VALOR"};
	...
	public ModelTabelaReceitaExtra() {
		dados = new ArrayList<ReceitaExtra>();

	}

	public void addRow(ReceitaExtra p) {
