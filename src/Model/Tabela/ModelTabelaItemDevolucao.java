...
public class ModelTabelaItemDevolucao extends AbstractTableModel {

	private List<ItemDevolucao> dados;
	private String[] colunas = { "Código", "Descrição", "Quant", "Custo", "Preço", "Total Custo", "Total Preço" };

	DecimalFormat df = new DecimalFormat("0.00");
	SimpleDateFormat dt = new SimpleDateFormat("dd/MM/yyyy");

	public List<ItemDevolucao> getDados() {
		return dados;
	}

	public void setDados(List<ItemDevolucao> dados) {
		this.dados = dados;
	}
	...
	public ModelTabelaItemDevolucao() {
		dados = new ArrayList<ItemDevolucao>();

	}

	public void addRow(ItemDevolucao p) {
